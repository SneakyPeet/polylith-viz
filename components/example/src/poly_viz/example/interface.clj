(ns poly-viz.example.interface
  "This is an example namespace for testing taken from https://github.com/weavejester/codox/tree/master/example/src/clojure/codox"
